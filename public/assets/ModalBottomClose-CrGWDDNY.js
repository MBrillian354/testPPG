import{r as i,j as e}from"./index-CBFEDf3H.js";const m=({isOpen:s,onClose:o,title:n,children:r,footer:l})=>{const[t,a]=i.useState(!1);i.useEffect(()=>(s?(a(!0),document.body.style.overflow="hidden"):(a(!1),document.body.style.overflow="unset"),()=>{document.body.style.overflow="unset"}),[s]);const d=()=>{a(!1),setTimeout(o,300)};return!s&&!t?null:e.jsxs("div",{className:"fixed inset-0 z-50 flex items-center justify-center",onClick:d,children:[e.jsx("div",{className:`
